...
const About = () => {
  return (
    <>
      ...
      <NavBar />
      <div className="mb-16 grid grid-cols-2 gap-5 px-16 py-5">
        ...
        <div className="ml-10">
          <Image
            className=" mb-16 w-96 rotate-2 rounded-xl"
            src="/portrait.webp"
            alt="portrait"
            height="640"
            width="640"
          ...
          <div className="border-b-2 border-zinc-400 pb-16">
            <Link href="https://www.twitter.com/">
              <p className="mt-4 flex text-sm font-medium text-zinc-200 hover:text-teal-500">
                <TwitterIcon />
